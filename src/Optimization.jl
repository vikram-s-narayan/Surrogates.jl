...
function surrogate_optimize(obj::Function, ::SRBF, lb, ub, surr::AbstractSurrogate,
    ...
    println("this is type of surr: ", typeof(surr))
    println("this is value of needs_gradient: ", needs_gradient)
    scale = 0.2
    success = 0
    failure = 0
